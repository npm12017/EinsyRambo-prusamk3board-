...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to floating numbers arduino 1.8.979.2, aggressive factor of .15 (vs .1, 1, 10)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT  {79.92, 80.14, 382.42 , 830 } //old Z@16 422.85 old E0@32 415
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
//#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 400, 5000 }
#define DEFAULT_MAX_ACCELERATION      {500,450,50,100}
/**
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER  -1.20 //-0.75    //-1.7   // Z offset: -0 is lower/below + 0 above/higher [the nozzle]
...
#define DISABLE_E  // For all extruders
...
#define INVERT_Y_DIR false //11/04/2019 09/04/2019
...
//#define DISABLE_M503    // Saves ~2700 bytes of PROGMEM. Disable for release! 27/032019 NM
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_END_POINT   {40, 20, (Z_MIN_POS + 1)}
