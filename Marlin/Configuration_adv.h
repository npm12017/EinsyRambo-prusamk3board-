...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       80  // (mm) The length of filament for a complete unload.
                                                  ...
                                                  // PRUSA MK2S/3S: PTFE 45mm, Heatsink 42.5mm - 6.5mm (for PTFE) - 15mm for Heatbreak
 ...
 */
  ...
  #define SENSORLESS_HOMING // TMC2130 only
    ...
    #define X_HOMING_SENSITIVITY  3 //3
    #define Y_HOMING_SENSITIVITY  3 //3
    ...
    #define SENSORLESS_HOMING_CURRENT
        ...
        #define X_HOMING_CURRENT    200
        #define Y_HOMING_CURRENT    230
